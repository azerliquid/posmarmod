					...
					Chart.controllers.horizontalBar = Chart.controllers.bar.extend(
						{
							...
							calculateBarBase: function (datasetIndex, index) {
								...
								if (xScale.options.stacked) {
									var value = this.chart.data.datasets[
										datasetIndex
									].data[index];

									if (value < 0) {
										for (var i = 0; i < datasetIndex; i++) {
											var negDS = this.chart.data
												.datasets[i];
											var negDSMeta = this.chart.getDatasetMeta(
												i
											);
											if (
												negDSMeta.bar &&
										...
										for (var j = 0; j < datasetIndex; j++) {
											var posDS = this.chart.data
												.datasets[j];
											var posDSMeta = this.chart.getDatasetMeta(
												j
											);
											if (
												posDSMeta.bar &&
							...
							calculateBarX: function (index, datasetIndex) {
								...
								if (xScale.options.stacked) {
									...
									for (var i = 0; i < datasetIndex; i++) {
										var ds = this.chart.data.datasets[i];
										var dsMeta = this.chart.getDatasetMeta(
											i
										);
										if (
											dsMeta.bar &&
				...
				module.exports = function (Chart) {
					...
					Chart.controllers.line = Chart.DatasetController.extend({
						...
						getPointBackgroundColor: function (point, index) {
							var backgroundColor = this.chart.options.elements
						...
						getPointBorderColor: function (point, index) {
							var borderColor = this.chart.options.elements.point
								.borderColor;
							var dataset = this.getDataset();
							var custom = point.custom || {};
				...
				module.exports = function (Chart) {
					...
					Chart.controllers.radar = Chart.DatasetController.extend({
						...
						update: function update(reset) {
							...
							var dataset = this.getDataset();
							var lineElementOptions = this.chart.options.elements
								.line;
							...
							helpers.each(
								...
								function (dataset, datasetIndex) {
									...
									if (meta.controller) {
										...
										meta.controller = new Chart.controllers[
											meta.type
										](this, datasetIndex);
							...
							if (
								...
								animation.render = function (
									...
									var stepDecimal =
										animationObject.currentStep /
										animationObject.numSteps;
									var easeDecimal = easingFunction(
										stepDecimal
									);
			...
			function (require, module, exports) {
				...
				module.exports = function (Chart) {
					...
					function getConstraintDimension(
						...
						var constrainedNode = view.getComputedStyle(domNode)[
							maxStyle
						];
				...
				module.exports = function () {
					...
					var Chart = function (context, config) {
						...
						this.height =
							...
							parseInt(
								Chart.helpers.getStyle(context.canvas, "height")
							) ||
				...
				module.exports = function (Chart) {
					...
					Chart.Scale = Chart.Element.extend({
						...
						calculateTickRotation: function () {
							...
							var firstWidth = context.measureText(this.ticks[0])
								.width;
						...
						fit: function () {
							...
							if (tickOpts.display && display) {
								...
								if (isHorizontal) {
									...
									if (!mirror) {
										largestTextWidth += this.options.ticks
											.padding;
									} else {
							...
							if (this.isHorizontal()) {
								...
								helpers.each(
									...
									function (label, index) {
										...
										var xLineValue = this.getPixelForTick(
											index
								...
								helpers.each(
									...
									function (label, index) {
										...
										var yLineValue = this.getPixelForTick(
											index
										); // xvalues for grid lines
				...
				module.exports = function (Chart) {
					...
					var LinearRadialScale = Chart.Scale.extend({
						...
						fit: function () {
							...
							furthestRightAngle = this.getIndexAngle(
								furthestRightIndex
							);
							furthestLeftAngle = this.getIndexAngle(
								furthestLeftIndex
							);
						...
						getPointPosition: function (index, distanceFromCenter) {
							...
							return {
								x:
									Math.round(
										Math.cos(thisAngle) * distanceFromCenter
									) + this.xCenter,
								y:
									Math.round(
										Math.sin(thisAngle) * distanceFromCenter
									) + this.yCenter,
							};
						},
							...
							if (this.options.display) {
								...
								if (!this.options.lineArc) {
									...
									for (
										...
										var labelsCount = this.pointLabels
												.length,
											halfLabelsCount =
					...
					var TimeScale = Chart.Scale.extend({
						...
						buildTicks: function (index) {
							...
							if (this.options.time.unit) {
								...
								var tickLabelWidth = this.ctx.measureText(
									tempFirstLabel
								).width;
								var cosRotation = Math.cos(
									helpers.toRadians(
