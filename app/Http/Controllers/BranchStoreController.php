...
class BranchStoreController extends Controller
{
    ...
    {
        $branch = BranchStore::with('cashier', 'chef', 'chef2')->get();
        $employe = Employe::all();
    ...
    public function store(Request $request)
    {
        ...
        $branchstore->branch_name = $request->name_branch;
    ...
    public function update(Request $request, $id)
    {
        ...
        //     $employe = Employe::find($request->headoffice);
        //     $employe->id_branch = $request->headoffice  == 'default ' ? null : $id;
        //     $employe->role = 'Kepala Toko';
        //     $employe->save();
        // }
        // if ($request->cashier) {
        //     $employe = Employe::find($request->cashier);
        //     $employe->id_branch = $request->cashier  == 'default ' ? null : $id;
        //     $employe->role = 'Kasir';
        //     $employe->save();
            
        // }if ($request->chef) {
        //     $employe = Employe::find($request->chef);
        //     $employe->id_branch = $request->chef  == 'default ' ? null : $id;
        //     $employe->role = 'Dapur';
        //     $employe->save();
        // }
